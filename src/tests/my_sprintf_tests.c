...
START_TEST(sprintf_wchar_NULL) {
  ...
  char str2[100];
  char *format = "%lc";
  wchar_t *stringLong = my_NULL;
  my_sprintf(str1, format, stringLong);
...
START_TEST(sprintf_wchar) {
  ...
  my_sprintf(str1, format, longChar);
...
START_TEST(sprintf_char_spec_both) {
  ...
  char c = 'a';
  char str[] = "booba";
  my_sprintf(str1, format, c, str, c, 9, str);
...
START_TEST(d_len) {
  ...
  int var2 = 0;
  long int var3 = 0;
  ck_assert_int_eq(my_sprintf(str1, format, var1, var2, var3),
  ...
  ck_assert_int_eq(my_sprintf(str1, format, var3, var3, var3),
...
START_TEST(d_flags) {
  ...
  int var = 21;
  ck_assert_int_eq(my_sprintf(str1, format, var), sprintf(str2, format, var));
  ck_assert_str_eq(str1, str2);
...
START_TEST(d_width) {
  ...
  ck_assert_int_eq(my_sprintf(str1, format, 20, var),
                   sprintf(str2, format, 20, var));
  ck_assert_str_eq(str1, str2);

  ck_assert_int_eq(my_sprintf(str1, format, 0, var),
  ...
  format = "Min field width %-*d";
  ck_assert_int_eq(my_sprintf(str1, format, 10, var),
...
START_TEST(ld_hd_flags) {
  ...
  ck_assert_int_eq(my_sprintf(str1, format, 10, val1),
  ...
  format = "%010hd";
  short val2 = -999;
  ck_assert_int_eq(my_sprintf(str1, format, 10, val2),
...
START_TEST(i_random) {
  ...
  ck_assert_int_eq(my_sprintf(str1, format, 10, var1),
                   sprintf(str2, format, 10, var1));
  ck_assert_str_eq(str1, str2);

  format = "Everythind at once %+-*.*i, %i";
  ck_assert_int_eq(my_sprintf(str1, format, 20, 10, var, var),
...
START_TEST(u_len) {
  ...
  ck_assert_int_eq(my_sprintf(str1, format, val1, val2, val3),
                   sprintf(str2, format, val1, val2, val3));
  ck_assert_str_eq(str1, str2);

  val2 = UINT32_MAX;
  ck_assert_int_eq(my_sprintf(str1, format, val1, val2, val2),
                   sprintf(str2, format, val1, val2, val2));
  ck_assert_str_eq(str1, str2);

  ck_assert_int_eq(my_sprintf(str1, format, val1, val1, val1),
                   sprintf(str2, format, val1, val1, val1));
  ck_assert_str_eq(str1, str2);

  ck_assert_int_eq(my_sprintf(str1, format, val3, val3, val3),
...
START_TEST(u_precision) {
  ...
  format = "Unsigned precicion %*.*u";
  ck_assert_int_eq(my_sprintf(str1, format, 20, 10, var),
...
START_TEST(o_len) {
  ...
  ck_assert_int_eq(my_sprintf(str1, format, uval1, uval2, uval3),
                   sprintf(str2, format, uval1, uval2, uval3));
  ck_assert_str_eq(str1, str2);

  ck_assert_int_eq(my_sprintf(str1, format, uval1, uval1, uval1),
...
START_TEST(o_width_flags) {
  ...
  format = "Min field width %+*o";
  ck_assert_int_eq(my_sprintf(str1, format, 11, var),
                   sprintf(str2, format, 11, var));
  ck_assert_str_eq(str1, str2);

  format = "Min field width % *o";
  ck_assert_int_eq(my_sprintf(str1, format, 12, var),
                   sprintf(str2, format, 12, var));
  ck_assert_str_eq(str1, str2);

  format = "Min field width %+#*o";
  ck_assert_int_eq(my_sprintf(str1, format, 13, var),
                   sprintf(str2, format, 13, var));
  ck_assert_str_eq(str1, str2);

  format = "Min field width % #*o";
  ck_assert_int_eq(my_sprintf(str1, format, 14, var),
                   sprintf(str2, format, 14, var));
  ck_assert_str_eq(str1, str2);

  format = "Min field width %- #*o";
  ck_assert_int_eq(my_sprintf(str1, format, 15, var),
  ...
  format = "Min field width %-*o";
  ck_assert_int_eq(my_sprintf(str1, format, 16, var),
                   sprintf(str2, format, 16, var));
  ck_assert_str_eq(str1, str2);

  format = "Min field width %0*o";
  ck_assert_int_eq(my_sprintf(str1, format, 17, var),
                   sprintf(str2, format, 17, var));
  ck_assert_str_eq(str1, str2);

  format = "Min field width %0#*o";
  ck_assert_int_eq(my_sprintf(str1, format, 18, var),
                   sprintf(str2, format, 18, var));
  ck_assert_str_eq(str1, str2);

  format = "Min field width %+#*o";
  ck_assert_int_eq(my_sprintf(str1, format, 19, var),
  ...
  format = "Min field width %- #*o";
  ck_assert_int_eq(my_sprintf(str1, format, 21, var),
...
START_TEST(e_len) {
  ...
  ck_assert_int_eq(my_sprintf(str1, format, var1, var2),
  ...
  ck_assert_int_eq(my_sprintf(str1, format, var2, var1),
...
START_TEST(e_flags) {
  ...
  format = "%e% -40E";
  ck_assert_int_eq(my_sprintf(str1, format, var, var),
...
START_TEST(e_width) {
  ...
  ck_assert_int_eq(my_sprintf(str1, format, 40, var),
  ...
  format = "Min field width %+-*e";
  ck_assert_int_eq(my_sprintf(str1, format, 41, var),
                   sprintf(str2, format, 41, var));
  ck_assert_str_eq(str1, str2);

  format = "Min field width %0*E";
  ck_assert_int_eq(my_sprintf(str1, format, 42, var),
...
START_TEST(e_precision) {
  ...
  var = 15.35;
  format = "%.17Le";
  ck_assert_int_eq(my_sprintf(str1, format, lvar),
...
START_TEST(f_len) {
  ...
  ck_assert_int_eq(my_sprintf(str1, format, var2),
  ...
  ck_assert_int_eq(my_sprintf(str1, "%f", 0.0001),
...
START_TEST(f_flags) {
  ...
  format = "%+ 40f";
  ck_assert_int_eq(my_sprintf(str1, format, -var),
...
START_TEST(g_len) {
  ...
  format = "%g";
  var1 = 0.005;
  ck_assert_int_eq(my_sprintf(str1, format, var1),
...
START_TEST(g_trailing_zero) {
  ...
  char format[] = "%g";
  double hex = 0.50300;
  ck_assert_int_eq(my_sprintf(str1, format, hex), sprintf(str2, format, hex));
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
START_TEST(n_spec) {
  ...
  ck_assert_int_eq(my_sprintf(str1, format, &n_smb1),
  ...
  ck_assert_int_eq(my_sprintf(str1, format, 1, 0, 0, &n_smb1),
  ...
  ck_assert_int_eq(my_sprintf(str1, format, &ln_smb1),
  ...
  ck_assert_int_eq(my_sprintf(str1, format, &hn_smb1),
...
START_TEST(perc_width) {
  ...
  ck_assert_int_eq(my_sprintf(str1, "abc%%abc"), sprintf(str2, "abc%%abc"));
  ck_assert_str_eq(str1, str2);

  // ck_assert_int_eq(my_sprintf(str1, "abc%10%abc"), sprintf(str2,
  // "abc%10%abc")); ck_assert_str_eq(str1, str2);
  // ck_assert_int_eq(my_sprintf(str1, "abc%-*%abc", 10), sprintf(str2,
  // "abc%-*%abc", 10)); ck_assert_str_eq(str1, str2);
  // ck_assert_int_eq(my_sprintf(str1, "abc%0*%abc", 10), sprintf(str2,
...
START_TEST(ptr) {
  ...
  char str2[BUFF_SIZE];
  char *format = "%p";
  ck_assert_int_eq(my_sprintf(str1, format, format),
...
START_TEST(test_one_char_with_alignment_right) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  ck_assert_int_eq(my_sprintf(str1, "%-8c", '\t'),
                   sprintf(str2, "%-8c", '\t'));
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
Suite *my_suite_sprintf(void) {
  Suite *s;
  TCase *tc;

  s = suite_create("my_sprintf tests");
